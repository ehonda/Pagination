...
using Core;
using Core.Fluent;
using Deprecated.OffsetBased.ItemExtractionHandling;
using Deprecated.OffsetBased.ItemExtractionHandling.Fluent;
using Deprecated.OffsetBased.PageRequestGenerationHandling;
using Deprecated.OffsetBased.PageRequestGenerationHandling.Fluent;
using Deprecated.OffsetBased.PaginationInformationHandling;
using Deprecated.OffsetBased.PaginationInformationHandling.Fluent;

namespace Deprecated.OffsetBased.Fluent;
